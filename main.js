import {probeBootModules} from "./boot-probe.js?v=4.0.2";

import {BodyEngine} from "./engine.js?v=4.0.2";
import {BodyUI} from "./ui.js?v=4.0.2";
import {setupDebug} from "./debug.js?v=4.0.2";
import {MeasurementLab} from "./generator.js?v=4.0.2";
import {BatchLab} from "./batch.js?v=4.0.2";
import {CalibrationLab} from "./calibration.js?v=4.0.2";
import {CalibratedSolverV37} from "./solver-v37.js?v=4.0.2";
import {SolverV312} from "./solver-v312.js?v=4.0.2";
import {FrozenSolverV311} from "./solver-v311-frozen.js?v=4.0.2";
import {FinalValidationV315} from "./final-validation.js?v=4.0.2";
import {SolverV316} from "./solver-v316.js?v=4.0.2";
import {MeasureReviewLab} from "./measure-review.js?v=4.0.2";
import {LiveManualReview} from "./live-review.js?v=4.0.2";
import {SilhouetteLab} from "./silhouette-lab.js?v=4.0.2";
...
async function boot(){
 ...
 const silhouetteLab=new SilhouetteLab(engine,ui,batchLab);
 engine.computeMetrics();
 progress("Body Lab bereit","MakeHuman · Maße · Revision geladen");
 setTimeout(()=>card.classList.add("hidden"),500);

 window.BodyLab={version:APP_VERSION,engine,ui,measurementLab,batchLab,calibrationLab,solverV37,solverV312,frozenSolverV311,finalSolverV316,finalValidationV315,measureReviewLab,liveManualReview,silhouetteLab};
}
boot().catch(err=>{
 console.error(err);
