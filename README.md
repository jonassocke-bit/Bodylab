# Harness Body Lab v3.3.0 — clean rewrite
...
## Rig / poses
The original MakeHuman default rig data is loaded and counted, but v3.3.0 deliberately does not
...
## v3.3.0 — Questionnaire Optimizer
