# Harness Body Lab v3.2.2 — clean rewrite
...
## Rig / poses
The original MakeHuman default rig data is loaded and counted, but v3.2.2 deliberately does not
