...
export class SolverV316{
 constructor(engine,ui,lab,batch){
  this.engine=engine;this.ui=ui;this.lab=lab;this.batch=batch;this.model=null;
  try{this.model=JSON.parse(localStorage.getItem("bodylab_v316_crosssection_model")||"null")}catch(e){}
 ...
 train(rows){
  ...
  try{localStorage.setItem("bodylab_v316_crosssection_model",JSON.stringify(this.model))}catch(e){}
  return this.model;
 }
